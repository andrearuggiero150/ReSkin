        ...
        <div class="collapse navbar-collapse" id="navigationBar">
            ...
            <div>
                <div class="d-flex justify-lg-content-end justify-content-start">
                    <form method="get" action="${pageContext.request.contextPath}/viewCartServlet">
                    <button type="submit" class="btn btn-outline-light m-1 order-lg-1 order-2" id="cartBtn">
