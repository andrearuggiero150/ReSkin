...
<div class="container">
    <div class="mx-auto text-center mt-5">
        <form class="row g-3" method="post" action="aggiornaProdottoServlet" id="idForm">
            <input type="hidden" value="" name="idProdotto">
            ...
            <div class="col-md-4">
                ...
                <input type="number" step="any" class="form-control" value="" id="Lunghezza" name="Lunghezza" placeholder="Lunghezza">
            </div>

            <div class="col-md-4">
                <label for="Larghezza" class="form-label">Larghezza</label>
                <input type="number" step="any" class="form-control" value="" id="Larghezza" name="Larghezza" placeholder="Larghezza">
            </div>

            <div class="col-md-4">
                <label for="Categoria" class="form-label">Categoria</label>
                <select class="form-select" id="Categoria" name="Categoria">
                    <option value="" data-nome="" selected></option>
                </select>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="Colore" name="Colore">
                    <option value="" data-nome="" selected></option>
                </select>
                <input type="hidden" id="ColoreNome" name="ColoreNome" value="">
            </div>

            <div class="col-md-4">
                <label for="Prezzo" class="form-label">Prezzo</label>
                <input type="number" step="any" class="form-control" value="" id="Prezzo" name="Prezzo" placeholder="Prezzo">
            </div>

            <div class="col-md-4">
                <label for="Quantità" class="form-label">Quantità</label>
                <input type="number" class="form-control" value="" id="Quantità" name="Quantità" placeholder="Quantità">
            </div>
