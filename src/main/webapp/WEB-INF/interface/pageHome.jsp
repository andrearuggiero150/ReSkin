...
<jsp:include page="headBar.jsp"/>
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading fw-normal lh-1"><%=prodotti.get(1).getNome()%><span class="text-body-secondary"><br><%=prodotti.get(1).getDescrizione()%></span></h2>
                <h3 class="lead">$<%=prodotti.get(1).getPrezzo()%></h3>
            </div>
            <div class="col-md-5">
                <a href="${pageContext.request.contextPath}/productServlet?id=<%=prodotti.get(1).getProductID()%>">
                    <img src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(prodotti.get(1).getBinaryImage()) %>" class="card-img-top img-fluid" alt="IMMAGINE PRODOTTO">
                </a>
            </div>
        </div>
        <hr class="featurette-divider">
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading fw-normal lh-1"><%=prodotti.get(2).getNome()%><span class="text-body-secondary"><br><%=prodotti.get(2).getDescrizione()%></span></h2>
                <p class="lead">$<%=prodotti.get(2).getPrezzo()%></p>
            </div>
            <div class="col-md-5 order-md-1">
                <a href="${pageContext.request.contextPath}/productServlet?id=<%=prodotti.get(2).getProductID()%>">
                    <img src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(prodotti.get(2).getBinaryImage()) %>" class="card-img-top img-fluid"  alt="IMMAGINE PRODOTTO">
                </a>
            </div>
        </div>
        <hr class="featurette-divider">
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading fw-normal lh-1"><%=prodotti.get(3).getNome()%><span class="text-body-secondary"><br><%=prodotti.get(3).getDescrizione()%></span></h2>
                <p class="lead">$<%=prodotti.get(3).getPrezzo()%></p>
            </div>
            <div class="col-md-5">
                <a href="${pageContext.request.contextPath}/productServlet?id=<%=prodotti.get(1).getProductID()%>">
                    <img src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(prodotti.get(3).getBinaryImage()) %>" class="card-img-top img-fluid"  alt="IMMAGINE PRODOTTO">
                </a>
            </div>
        </div>
        <hr class="featurette-divider">
