...
<div class="container marketing">
    <div class="row">
        <div class="col-lg-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-instagram"
                 viewBox="0 0 16 16">
        ...
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
                ...
                <h4 class="text-body-secondary">
                    ...
                    e governi per promuovere una vera e propria transizione ecologica attraverso ampi programmi di
                    sviluppo,
                    diversi settori continuano a lottare per adottare le pratiche comuni necessarie per lo smaltimento
                    adeguato dei rifiuti.
                    Uno dei settori pi&ugrave; inquinanti che ha scalato posizioni, raggiungendo il secondo posto nella
                    graduatoria tra quelli pi&ugrave; dannosi per l&apos;ambiente
                    &egrave; senz&apos;altro quello della moda, in particolare il segmento noto come fast fashion
                    che si concentra sulla produzione in massa di capi d&apos;abbigliamento. Diversi report hanno
                    evidenziato la presenza di metano e petrolio
...
<footer class="container">
    <p class="float-end"><a href="#"
                            class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Torna
        su</a></p>
    <p>&copy; 2023 Company, Inc. &middot; <a href="#"
                                             class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Privacy</a>
        &middot; <a href="#"
                    class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Termini</a>
    </p>
</footer>
