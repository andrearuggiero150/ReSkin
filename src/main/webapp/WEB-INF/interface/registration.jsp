...
<div class="container">
        ...
        <form class="row g-3" >
            ...
            <div class="col-11" >
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="terms" value="agree" id="check" required>
                    <label class="form-check-label" for="check">
                        Accetto i termini e condizioni del sito sul trattamento dei dati
                    </label>
                </div>
            </div>
            <div class="col-12">
    ...
    <a href="${pageContext.request.contextPath}/index.html" class="fixed-bottom p-2"><button class="btn btn-outline-light">Registrazione Admin</button></a>
</div>
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="liveToast-6" class="toast bg-danger" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
            <div class="toast-body">
                Devi accettare i termini e le condizioni di trattamento dei dati.
            </div>
            <button type="button" class="btn-close me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
    </div>
...
<script>
    ...
    const toastLiveExample_6 = document.getElementById('liveToast-6')
    document.addEventListener("DOMContentLoaded", function() {
        setTimeout(function() {
            ...
            if (registerSuccess == -6) {
                const toastBootstrap = bootstrap.Toast.getOrCreateInstance(toastLiveExample_6)
                toastBootstrap.show()
            }
        })})
